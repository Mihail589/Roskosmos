...
float Kp = 0.15;              // Пропорциональный коэффициент
float Kd = 0.15;             // Дифференциальный коэффициент
float Ki =0.15;               // Интегральный коэффициент
...
int control(){
    ...
    int16_t mtr_speed;
    int16_t omega = 0;
    int16_t omega_goal = 10;  // Целевая угловая скорость
